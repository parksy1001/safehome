...
export const SnsSettingContext= React.createContext();
export const SnsContext= React.createContext();

export const TimeArrayContext= React.createContext();
export const Array0Context= React.createContext();
export const Array1Context= React.createContext();
export const Array2Context= React.createContext();
