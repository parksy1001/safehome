...
export default class FindPicoToScan_SignIn_Pre extends Component {
  constructor(props) {
    super(props);
    this.state = {
      scanning: false,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.isLocation === -1 ? null : this.state.isLocation === 1? (
            this.props.navigation.navigate('FindPicoToScan_SignIn', {strings:strings})
        ) : (
          <CustomModal
