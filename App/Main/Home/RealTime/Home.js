      ...
      {isLoading ? (
        <View style={{ alignItems: 'center' }}>
          ...
          <TouchableOpacity style={styles.viewBox}>
            ...
            {/* <View style={{flexDirection:'row'}}>
            <Text style = {{fontSize:15, fontFamily:'NotoSans-Regular', fontWeight:'bold', margin:13, color: '#444444'}}>SaiHome Connected</Text>
            <TouchableOpacity onPress={() => navigation.navigate('Connect')} style = {{height:30, width:30, borderRadius:100, backgroundColor:colors.azure, justifyContent:'center', alignItems:'center', alignSelf:'flex-end',marginBottom:7,}}>
              <Text style={{color:'white'}}>+</Text></TouchableOpacity>
            </View>
                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getPm25Color(79) }]}></View>
                    <Image style={styles.scan_icPm25} source={getPm25Picture(79)} />
                    <Text style={[styles.scan_pm25, { color: getPm25Color(79) }]}>{strings.scan_label_pm25}</Text>              
                    <Text style={[styles.scan_pm25Value, { color: getPm25Color(79) }]}>{parseInt(79)}</Text>
                    <Text style={[styles.scan_pm25m3, { color: getPm25Color(79) }]}>μg/m³</Text>  
                  </View>
                </View>

                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getPm10Color(99) }]}></View>
                    <Image style={styles.scan_icPm10} source={getPm10Picture(99)} />
                    <Text style={[styles.scan_pm10, { color: getPm10Color(99) }]}>{strings.scan_label_pm10}</Text>              
                    <Text style={[styles.scan_pm10Value, { color: getPm10Color(99) }]}>{parseInt(99)}</Text>
                    <Text style={[styles.scan_pm10m3, { color: getPm10Color(99) }]}>μg/m³</Text>  
                  </View>
                </View>
                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getTemperatureColor(21) }]}></View>
                    <Image style={styles.scan_icTemp} source={getTemperaturePicture(21)} />
                    <Text style={[styles.scan_temperature, { color: getTemperatureColor(21) }]}>{strings.scan_label_temperature}</Text>
                    <Text style={[styles.scan_temperatureValue, { color: getTemperatureColor(21) }]}>{parseInt(21)}</Text>
                    <Text style={[styles.scan_temperatureC, { color: getTemperatureColor(21) }]}>°C</Text>  
                  </View>
                </View>
                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getHumidColor(56) }]}></View>
                    <Image style={styles.scan_icHumdi} source={getHumidPicture(56)} />
                    <Text style={[styles.scan_humidity, { color: getHumidColor(56) }]}>{strings.scan_label_humidity}</Text>
                      <Text style={[styles.scan_humidityValue, { color: getHumidColor(56) }]}>{parseInt(56)}</Text>
                    <Text style={[styles.scan_humidityPercent, { color: getHumidColor(56) }]}>%</Text>
                  </View>
                </View>
                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getTvocColor(12) }]}></View>
                    <Image style={styles.scan_icVoc} source={getTvocPi
                      cture(12)} />
                    <Text style={[styles.scan_Voc, { color: getTvocColor(12) }]}>{strings.scan_label_vocs}</Text>

                      <Text style={[styles.scan_VocValue, { color: getTvocColor(12) }]}>{parseInt(12)}</Text>
                    <Text style={[styles.scan_Vocppb, { color: getTvocColor(12) }]}>ppb</Text>
                  </View>
                </View>
                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getCo2Color(72) }]}></View>
                    <Image style={styles.scan_icCO2} source={getCo2Picture(72)} />
                    <Text style={[styles.scan_CO2, { color: getCo2Color(72) }]}>{strings.scan_label_co2}</Text>
                    <Text style={[styles.scan_CO2Value, { color: getCo2Color(72) }]}>{parseInt(72)}</Text>
                    <Text style={[styles.scan_CO2ppm, { color: getCo2Color(72) }]}>ppm</Text>
                  </View>
                </View>

                <View style={styles.scan_box}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getCoColor(34) }]}></View>
                    <Image style={styles.scan_icCO2} source={getCoPicture(34)} />
                    <Text style={[styles.scan_CO2, { color: getCoColor(34) }]}>일산화탄소</Text>
                    <Text style={[styles.scan_CO2Value, { color: getCoColor(34) }]}>{parseInt(34)}</Text>
                    <Text style={[styles.scan_CO2ppm, { color: getCoColor(34) }]}>ppm</Text>
                  </View>
                </View>

                <View style={styles.scan_box_last}>
                  <View style={styles.scan_stateBox}>
                    <View style={[styles.scan_bgStateBar, { backgroundColor: getCh4Color(98) }]}></View>
                    <Image style={styles.scan_icCO2} source={getCh4Picture(98)} />
                    <Text style={[styles.scan_CO2, { color: getCh4Color(98) }]}>메테인</Text>
                    <Text style={[styles.scan_CO2Value, { color: getCh4Color(98) }]}>{parseInt(98)}</Text>
                    <Text style={[styles.scan_CO2ppm, { color: getCh4Color(98) }]}>ppb</Text>
                  </View>
                </View> */}
                <View>
                  <Text style={{fontSize:12, marginTop:height*0.15}}>아래의 + 버튼을 눌러 Safe Home을 연결해주세요.</Text>
                </View>
                <View>
                  <TouchableOpacity onPress={() => navigation.navigate('Connect')} style = {{height:70, width:70, borderRadius:100, backgroundColor:colors.azure, justifyContent:'center', alignItems:'center',marginBottom:7,marginTop:height*0.08}}>
