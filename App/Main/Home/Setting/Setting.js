  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.settingViewStyle}>
        <TouchableOpacity onPress={() => navigation.navigate('ViewAir')}>
          <View style={styles.managePicoHomeSetting}>
            ...
            <View style={styles.manageMyPicoHomeTextStyle}>
              ...
              <Text style={styles.manageMyPiCoHomeText}>공기질</Text>
            </View>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Terms')}>
          <View style={styles.managePicoHomeSetting2}>
            <View style={styles.icStuff2}>
              <Image source={require('../../../../Assets/img/icTerms2.png')} />
            </View>
            <View style={styles.manageMyPicoHomeTextStyle}>
              {/* <Text style={styles.manageMyPiCoHomeText}>{strings.setting_list_managing}</Text> */}
              <Text style={styles.manageMyPiCoHomeText}>약관</Text>
            </View>
            <View style={styles.icNextArrow}>
              <Image source={require('../../../../Assets/img/icMiniarrowLeft.png')} />
            </View>
        ...
        <TouchableOpacity  onPress={() => navigation.navigate('AppInfo')}>
          <View style={styles.managePicoHomeSetting2}>
            <View style={styles.icStuff2}>
              <Image source={require('../../../../Assets/img/icQuestion2.png')} />
            </View>
            <View style={styles.manageMyPicoHomeTextStyle}>
              {/* <Text style={styles.manageMyPiCoHomeText}>{strings.setting_list_managing}</Text> */}
              <Text style={styles.manageMyPiCoHomeText}>앱 정보</Text>
            </View>
            <View style={styles.icNextArrow}>
              <Image source={require('../../../../Assets/img/icMiniarrowLeft.png')} />
            </View>
      ...
      {/* <View style={styles.linkFldViewStyle}>
        ...
        <TouchableOpacity style={styles.linkFldUnitStyle} onPress={() => navigation.navigate('Terms')}>
      ...
      {/* <View style={styles.appInfoBundle}>
        <View style={styles.appInfoSingle}>
          <Text style={styles.appInfoTitle}>앱명칭</Text>
          <Text style={styles.appInfoContents}>Safe Home Care Aero System</Text>
        </View>
        <View style={styles.appInfoSingle}>
          <Text style={styles.appInfoTitle}>버전 v.1.0.0</Text>
          <Text style={styles.appInfoContents}>Safe Home Care Aero System</Text>
        </View>
        <View style={styles.appInfoSingle}>
          <Text style={styles.appInfoTitle}>개발사</Text>
          <Text style={styles.appInfoContents}>한방유비스 주식회사</Text>
        </View>
      </View> */}
      {/* <View style={styles.versionViewStyle}>
        <Text style={styles.versionStyle}>v.1.0.0</Text>
      </View> */}
    </View>
  );
}
