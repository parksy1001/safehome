...
import { LanguageContext, SettingContext, UserContext } from '../../../context';
...
export const SetUpPico = ({ navigation, route }) => {
  ...
  //console.log(id);
  //const { id, name, firmware } = { id:1, name:1, firmware:1 }
        ...
        <View>
          ...
          <View style={styles.box2}>
            ...
            <TextInput
              ...
              placeholder="평수를 입력하세요."></TextInput>
          </View>
...
const styles = StyleSheet.create({
  ...
  picoHomeBig: { marginTop: height * 0.05, alignItems: 'center' },
  button: {
    position: 'absolute',
    top: height * 0.74,
    width: width * 0.85,
