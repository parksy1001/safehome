...
import { AuthContext, FCMTokenContext, SignInContext, SignInErrorContext, UserContext, PlaceListContext, SnsContext} from '../context';
  ...
  return (
    ...
    <AuthContext.Provider value={authContext}>
      <UserContext.Provider value={userToken}>
        <SnsContext.Provider value={isSns}>
